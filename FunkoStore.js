...
// const Funkos = [funko1,funko2,funko3,funko4,funko5,funko6,funko7,funko8,funko9,funko10,funko11,funko12]
console.log(listaProductos.getFunkos())

// for (let elem of Funkos){
//     console.log(elem.nombre +" "+ elem.subcategoria +" "+ elem.precio)
// }
